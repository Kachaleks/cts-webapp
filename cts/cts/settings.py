...
SECRET_KEY = "django-insecure-hui-tebe"
...
# Медиафайлы (загружаемые пользователями) - для загруженных картинок
MEDIA_URL = "/media/camera_images/"
MEDIA_ROOT = BASE_DIR / "media/camera_images"
